...
class PathConfig:
    ...
    train_val_split_file = Path(intermediate_data_folder, "train_test_split.csv")
    train_val_split_gpkg_file = Path(intermediate_data_folder, "train_test_split_vis.gpkg")
